  ...
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      <Title
        ...
        subTitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque orci nisi, fringilla in urna at, tempor auctor nunc. Donec placerat sodales dolor vel aliquet. Integer ac est velit."
      />
